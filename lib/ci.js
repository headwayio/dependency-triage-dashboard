...
const UNKNOWN = { state: "unknown", headSha: null, isDraft: false, reviewDecision: null, reviewers: [], checks: [], failing: [] };
...
async function fetchPRStatusBatch(prs) {
  ...
  const fragment =
    "fragment prState on PullRequest { isDraft reviewDecision headRefOid " +
